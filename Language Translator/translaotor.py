...
trainX = encode_sequence(eng_toenizer, eng_length, X[:-100])
trainY = encode_sequence(fr, fr_length, y[:-100])
trainY = encode_output(trainY, fr_vocab_size)
# prepare validation data
testX = encode_sequence(eng_toenizer, eng_length, X[-100:])
testY = encode_sequence(fr_tokenizer, fr_length, y[-100:])
